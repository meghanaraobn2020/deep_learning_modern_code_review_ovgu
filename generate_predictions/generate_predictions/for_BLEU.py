...
for BEAM_SIZE in [10]:
    ...
    path_predictions = root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-comment/predictions/pre_training_code2comment/isr_learning_rate/predictions_' + str(BEAM_SIZE) + '.txt'
    path_statistics =  root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-comment/predictions/pre_training_code2comment/isr_learning_rate/statistics_' + str(BEAM_SIZE) + '.txt'
