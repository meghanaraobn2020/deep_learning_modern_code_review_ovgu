...
def code_bleu(ref, hyp):
    f = open(root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/beam_size_1/ref.txt', 'w')
    f.write(ref)
    f.close()
    f = open(root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/beam_size_1/hyp.txt', 'w')
    f.write(hyp)
    f.close()
...
for BEAM_SIZE in [1]:
    ...
    path_predictions = root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/beam_size_1/predictions_' + str(BEAM_SIZE) + '.txt'
    path_statistics = root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/beam_size_1/statistics_' + str(BEAM_SIZE) + '.txt'
    ...
    path_ref =  root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/beam_size_1/ref.txt'
    path_hyp =  root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/beam_size_1/hyp.txt'
