...
for BEAM_SIZE in [10]:
    ...
    path_predictions = root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/pre_training_code2code/isr_learning_rate/model_2/predictions_' + str(BEAM_SIZE) + '.txt'
    path_statistics = root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/pre_training_code2code/isr_learning_rate/model_2/statistics_' + str(BEAM_SIZE) + '.txt'
    ...
    path_ref = root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/pre_training_code2code/isr_learning_rate/model_2/ref.txt'
    path_hyp = root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/pre_training_code2code/isr_learning_rate/model_2/hyp.txt'
