...
def code_bleu(ref, hyp):
    f = open(root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/ref.txt', 'w')
    f.write(ref)
    f.close()
    f = open(root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/hyp.txt', 'w')
    f.write(hyp)
    f.close()
...
for BEAM_SIZE in [10]:
    ...
    path_targets = root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/test.tsv'
    path_predictions = root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/predictions_' + str(BEAM_SIZE) + '.txt'
    path_statistics = root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/statistics_' + str(BEAM_SIZE) + '.txt'
    ...
    path_ref = root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/ref.txt'
    path_hyp = root_path + 'data/dataset/dataset/fine-tuning/new_large/code_comment-to-code/predictions/pre_training_codecomment2code/isr_learning_rate/hyp.txt'
