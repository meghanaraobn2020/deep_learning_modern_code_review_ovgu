...
def code_bleu(ref, hyp):
    f = open(root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/isr_learning_rate/beam_size_5/ref.txt', 'w')
    f.write(ref)
    f.close()
    f = open(root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/isr_learning_rate/beam_size_5/hyp.txt', 'w')
    f.write(hyp)
    f.close()
...
for BEAM_SIZE in [5]:
    ...
    path_predictions = root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/isr_learning_rate/beam_size_5/predictions_' + str(BEAM_SIZE) + '.txt'
    path_statistics = root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/isr_learning_rate/beam_size_5/statistics_' + str(BEAM_SIZE) + '.txt'
    ...
    path_ref =  root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/isr_learning_rate/beam_size_5/ref.txt'
    path_hyp =  root_path + 'data/dataset/dataset/fine-tuning/new_large/code-to-code/predictions/isr_learning_rate/beam_size_5/hyp.txt'
